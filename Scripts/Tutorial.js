...
function drawTutorial2(parent, iLevel, ttRef) {
  ...
  if (iLevel === 0) {
    ...
    sText = "Unter der Überschrift \"Individuelle Fähigkeiten\" sind die einzelnen Fähigkeiten deines Spielers aufgelistet. Aus ihnen sowie der Moral und der Frische deines Spielers setzt sich seine aktuelle Stärke zusammen. Bei der bereinigten Stärke wird für die Frische und die Moral ein Wert von 100% angenommen.";
    iNextButton = 1;
  } else if (iLevel === 13) {
    sText = "Die individuellen Fähigkeiten kannst du als Trainer auf zwei Arten beeinflussen:</br>Zum Einen wird durch Mannschaftstraining wie \"Torschüsse\" der Trainingswert der Fähigkeit (in diesem Fall \"Schusskraft\" und \"Schussgenauigkeit\") verbessert.</br>Zum Anderen kann ein Spieler auch eine Fähigkeit individuell trainieren. Welche das ist, kannst du über die Knöpfe unter \"Ind.\" festlegen. Mit jedem Mannschaftstraining (aber auch durch Aktionen im Spiel) steigt sein Bonus in dieser Fähigkeit an, wodurch seine Chancen erhöht werden, sich in dieser um ein Level zu verbessern.";
    iNextButton = 1;
  } else if (iLevel === 14) {
